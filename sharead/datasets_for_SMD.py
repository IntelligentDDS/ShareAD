...
class MonitorEntityDataset_SMD(Dataset):
    def __init__(self, trainfiles, testfiles, sequence_length, z_dim, period=1440, use_sfa=True, no_longterm=False, largest_bin=8, seed=0, is_minmax=False, gpu=None):
        ...
        for i in range(len(trainfiles)):
            ...
            self.mac_ids.append(testfiles[i])
